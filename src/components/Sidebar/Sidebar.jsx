    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => setMenudata("Visa")}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => setMenudata("Community")}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => setMenudata("Rentals")}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
